	                ...
	                <div class="card-body">
	                    <form method="POST" action="{{ route('users.store') }}">
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-6">
	                                <input id="payment" type="text" class="form-control @error('payment') is-invalid @enderror" name="payment" value="{{ old('payment') }}" autocomplete="payment">
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-6">
	                                <input id="paid_at" type="date" class="form-control @error('paid_at') is-invalid @enderror" name="paid_at" value="{{ old('paid_at') }}" autocomplete="paid_at">
